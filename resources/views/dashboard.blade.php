                ...
                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y" onclick="window.location.href='#'">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            ...
                            <div class="text-base text-gray-600 mt-1">Owners</div>
                        </div>
                    </div>
                </div>
                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y"
                    ...
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            ...
                            <div class="text-base text-gray-600 mt-1">user Flags</div>
                        </div>
                    </div>
                </div>
                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y" onclick="window.location.href='#'">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            ...
                            <div class="text-3xl font-bold leading-8 mt-6">34</div>
                            <div class="text-base text-gray-600 mt-1">Owner Flags</div>
                        </div>
                    </div>
                </div>
