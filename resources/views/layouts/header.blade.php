    ...
    <div class="mobile-menu md:hidden">
        <div class="mobile-menu-bar">
            <a href="{{ route('dashboard') }}" class="flex mr-auto">
                ...
                <span class="hidden xl:block text-white text-lg ml-3"> Biji App </span>
            </a>
        ...
        <ul class="border-t border-theme-24 py-5 hidden">
            ...
            <li>
                <a href="{{ route('owners') }}" class="menu <?php if($pagename==" owners")echo 'menu--active' ; ?>">
                    <div class="menu__icon"> <i data-feather="users"></i> </div>
                    <div class="menu__title"> Owners </div>
                </a>
            </li>
            <li>
                <a href="{{ route('user_flags') }}" class="menu <?php if($pagename==" user_flags")echo 'menu--active' ; ?>">
                    <div class="menu__icon"> <i data-feather="users"></i> </div>
                    <div class="menu__title"> Users Flags</div>
                </a>
            </li>
            <li>
                <a href="{{ route('owner_flags') }}" class="menu <?php if($pagename==" owner_flags")echo 'menu--active' ; ?>">
                    <div class="menu__icon"> <i data-feather="users"></i> </div>
                    <div class="menu__title"> Owners Flags</div>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="flex">
        ...
        <nav class="side-nav">
            <a href="{{ route('dashboard') }}" class="intro-x flex items-center pl-5 pt-4">
                <img alt="Admin Template" class="img-fluid " style="width:20%;  border-radius: 50%;"
                    src="{{asset('assets/dist/logo.png')}}">
                <span class="hidden xl:block text-white text-lg ml-3"> Bijy App </span>
            </a>
            ...
            <ul>
                ...
                <li>
                    <a href="{{route('owners')}}" class="side-menu <?php if($pagename=='owners')echo 'side-menu--active'; ?>">
                        <div class="side-menu__icon"> <i data-feather="users"></i> </div>
                        <div class="side-menu__title"> Owners </div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_flags') }}"
                        class="side-menu <?php if($pagename=='user_flags')echo 'side-menu--active'; ?>">
                        <div class="side-menu__icon"> <i data-feather="users"></i> </div>
                        <div class="side-menu__title"> Users Flags </div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('owner_flags') }}"
                        class="side-menu <?php if($pagename=='owner_flags')echo 'side-menu--active'; ?>">
                        <div class="side-menu__icon"> <i data-feather="users"></i> </div>
                        <div class="side-menu__title"> Owner Flags </div>
                    </a>
                </li>
